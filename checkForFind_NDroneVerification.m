function [potentialFindsMatrix, stats, droneInfo, simulation_flag] = checkForFind_NDroneVerification(droneInfo, targetLocation, maxSearchRadius, num_verify, stats, chanceOfFalsePositive, potentialFindsMatrix)
